 ...
 *
 * Combines a lookup table for O(1) code access with a bit-level writer,
 * processing input bytes in batches of 4 to maximize CPU pipeline utilization.
 *
 ...
 */
class HuffmanCodeWriter(
    codeTable: Map<Int, HuffmanCode>,
