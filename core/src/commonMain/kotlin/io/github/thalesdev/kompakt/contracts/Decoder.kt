 ...
 *
 * Defines the contract for algorithms that can decompress byte arrays
 * in-memory. Implementations should handle the entire compressed data at once,
...
interface Decoder<Meta : MetaData> {
     ...
     *
     * Processes the entire compressed input using the provided metadata
     * and reconstructs the original uncompressed data.
     *
     ...
     * ```
     */
    suspend fun decode(compressed: CompressedData<Meta>): ByteArray
}
