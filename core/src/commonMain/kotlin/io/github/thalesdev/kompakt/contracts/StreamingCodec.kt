 ...
 *
 * Represents a full bidirectional streaming compression algorithm that can both
 * encode (compress) and decode (decompress) data in chunks using Kotlin Flow.
 * This interface combines [StreamEncoder] and [StreamDecoder] capabilities.
 *
 * Implementations provide complete round-trip streaming compression/decompression
 * with constant memory usage, making them suitable for large files or continuous
 * data streams that cannot fit entirely in memory.
 *
