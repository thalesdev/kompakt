 ...
 *
 * Represents a full bidirectional compression algorithm that can both encode (compress) and decode
 * (decompress) data. This interface combines [Encoder] and [Decoder] capabilities into a single
 * codec.
 *
 * Implementations provide complete round-trip compression/decompression for data that fits in
 * memory. For large files or streaming scenarios, use [StreamingCodec] instead.
 *
