 ...
 *
 * This type alias represents a factory pattern for creating Flows that emit byte arrays. The
 * factory can be invoked multiple times to create new Flow instances, which is useful for
 * multi-pass algorithms that need to process the same data source multiple times.
 *
 * Each invocation of the factory should create a fresh Flow that starts from the beginning of the
 * data source.
 *
 * Example:
 * ```
